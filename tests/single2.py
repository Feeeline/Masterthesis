...
log_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'parser_run_single2.log'))
...
latex_output_path = os.path.abspath(
    os.path.join(
        ...
        "Overleaf_LaTeX",
        "tabellen",
        "aspen_luftzerlegung_streams_single2.tex",
    )
)
...
components_output_path = os.path.abspath(
    os.path.join(
        ...
        "Overleaf_LaTeX",
        "tabellen",
        "aspen_luftzerlegung_components_single2.tex",
    )
)
...
components_work_output_path = os.path.abspath(
    os.path.join(
        ...
        "Overleaf_LaTeX",
        "tabellen",
        "aspen_luftzerlegung_components_work_single2.tex",
    )
)
...
block_ed_output_path = os.path.abspath(
    os.path.join(
        ...
        "Overleaf_LaTeX",
        "tabellen",
        "aspen_luftzerlegung_blocks_ed_single2.tex",
    )
)
...
block_ed_comparison_output_path = os.path.abspath(
    os.path.join(
        ...
        "Overleaf_LaTeX",
        "tabellen",
        "aspen_luftzerlegung_blocks_ed_comparison2.tex",
    )
)
...
molfractions_output_path = os.path.abspath(
    os.path.join(
        ...
        "Overleaf_LaTeX",
        "tabellen",
        "aspen_luftzerlegung_streams_molfrac_single2.tex",
    )
)
