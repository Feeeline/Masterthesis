...
@component_registry
class RadFrac(Component):
    r"""
    Class for exergy and exergoeconomic analysis of Aspen RadFrac components.

    This class models a distillation/absorption column with multiple inlet and
    outlet streams. Optional condenser/reboiler heat interactions are accounted
    for if heat connections are provided.
    """

    def __init__(self, **kwargs):
        r"""Initialize the RadFrac component with given parameters."""
    ...
    def calc_exergy_balance(self, T0: float, p0: float, split_physical_exergy) -> None:
        r"""
        Compute the exergy balance of the RadFrac column.
        ...
        if len(self.inl) < 1 or len(self.outl) < 2:
            raise ValueError("RadFrac requires at least one inlet and two outlets.")
        ...
        logging.info(
            f"Exergy balance of RadFrac {self.name} calculated: "
