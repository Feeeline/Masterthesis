...
Die grafische Darstellung der Kostenverteilung erfolgt auf Basis der Bare-Module-Kosten \(C_{\mathrm{BM}}\). Dabei werden die apparatespezifischen Bare-Module-Kosten einschließlich des Kolonnenblocks und der pauschal
berücksichtigten Luftvorreinigung den jeweiligen Funktionsblöcken zugeordnet.
Indirekte Kosten, Unvorhergesehenes sowie die zusätzlichen Bestandteile des Total Capital Investment werden nicht auf die Funktionsblöcke verteilt, da diese Zuschläge summarisch angesetzt werden.
