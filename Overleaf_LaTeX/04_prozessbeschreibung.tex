...
\begin{table}[h]
\centering
\caption{Berechnete Stoffströme für das geforderte Stickstoffprodukt in der großen und skalierten Variante (bei Normbedingungen \(T_\mathrm{N}=273{,}15~\mathrm{K},\ p_\mathrm{N}=1{,}013~\mathrm{bar}\)).}
